...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<HomeItem> getMedicineList() {
        ...
        Cursor cursor = db.query(DB_TABLE, new String[]{KEY_NAME, KEY_TIMES_PER_DAY,KEY_TOTAL_DOSES,KEY_TIMINGS}, null, null, null, null, null);
        while (cursor.moveToNext()) {
            HomeItem homeItem = new HomeItem(cursor.getString(0)  , cursor.getString(1),cursor.getString(2),cursor.getString(3));
